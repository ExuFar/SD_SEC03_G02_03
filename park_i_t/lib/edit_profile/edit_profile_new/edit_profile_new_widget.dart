...
import '/edit_profile/edit_profile_picture/edit_profile_picture_widget.dart';
...
import 'edit_profile_new_model.dart';
export 'edit_profile_new_model.dart';

class EditProfileNewWidget extends StatefulWidget {
  const EditProfileNewWidget({super.key});

  @override
  State<EditProfileNewWidget> createState() => _EditProfileNewWidgetState();
}

class _EditProfileNewWidgetState extends State<EditProfileNewWidget>
    with TickerProviderStateMixin {
  late EditProfileNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditProfileNewModel());
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment: const AlignmentDirectional(1.61, 1.28),
